...
#[contract]
pub struct Sep7PrintablePaymentQrForPrintMediaContract;

#[contractimpl]
impl Sep7PrintablePaymentQrForPrintMediaContract {
    ...
    pub fn pay_payments_record(env: Env, id: String, actor: Address, amount: i128, score: u32) -> Result<(), Error> {
        if amount <= 0 {
            return Err(Error::InvalidAmount);
        }
